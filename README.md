...
```bash
bash <(curl -sSL https://raw.githubusercontent.com/LAGcomcom/frp-panel-release/main/install.sh)
```

或者：

```bash
curl -sSL https://raw.githubusercontent.com/LAGcomcom/frp-panel-release/main/install.sh -o install.sh
bash install.sh
```
